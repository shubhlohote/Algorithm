...
public class Simulation {
    ...
    public static void main(String[] args) {
        ...
        System.out.print("Sold Items Count:");
        System.out.println(AuctionServer.getInstance().soldItemsCount());
        System.out.print("Disqualified Sellers :");
        System.out.println(AuctionServer.getInstance().getDisqualifiedSellers());
        System.out.print("Unsold Items :");
        System.out.println(AuctionServer.getInstance().getUnsoldItems());
        System.out.print("Total Items :");
        System.out.println(AuctionServer.getInstance().getTotalItems());        
    }
}
